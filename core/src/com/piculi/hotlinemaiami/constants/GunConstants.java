...
public class GunConstants {
    ...
    public static final Color PISTOL_BULLET_COLOR = Color.GOLD;
    public static final long PISTOL_TIME_BETWEEN_SHOTS = 500;
    ...
    public static final int AK47_BULLET_SPEED = 20;
    public static final int AK47_BULLET_HEIGHT = 3;
    public static final int AK47_BULLET_WIDTH = 3;
    public static final Color AK47_BULLET_COLOR = Color.GOLD;
    public static final long AK47_TIME_BETWEEN_SHOTS = 100;
    public static final int AK47_WIDTH = 7;
    ...
    public static final long SHOTGUN_TIME_BETWEEN_SHOTS = 1000;
    public static final int SHOTGUN_WIDTH = 14;
